	...
	if ( is_woocommerce_active() ) {
		class Shop_Category_Filter extends WP_Widget {
			...
			public function form( $instance ) {
				...
				?>
						<p>
							<label for="<?php echo $this->get_field_id( 'title_' . $attribute->attribute_name ); ?>"><?php _ex( 'Title for attribute:', 'backend', 'organique_wp' ); ?> <strong><?php echo $attribute->attribute_name; ?></strong></label>
						...
						<p>
							<input id="<?php echo $this->get_field_id( 'show_' . $attribute->attribute_name ); ?>" name="<?php echo $this->get_field_name( 'show_' . $attribute->attribute_name ); ?>" type="checkbox" value="1" <?php checked( $instance['show_' . $attribute->attribute_name], '1' ); ?> /> <label for="<?php echo $this->get_field_id( 'show_' . $attribute->attribute_name ); ?>"><?php _ex( 'Show filter for attribute:', 'backend', 'organique_wp'); ?> <strong><?php echo $attribute->attribute_name; ?></strong></label>
						</p>
